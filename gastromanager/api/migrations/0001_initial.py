    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("flavor", models.CharField(default="", max_length=255)),
                (
                    "size",
                    models.FloatField(
                        choices=[(0.5, "0.5 Litres"), (3, "3 Litres"), (6, "6 Litres")],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "base",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="api.base"
                    ),
                ),
                (
                    "recipe",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="recipes", through="api.RecipeBase", to="api.base"
            ),
        ),
        migrations.AddField(
            model_name="recipe",
        ...
        migrations.AddField(
            ...
            name="recipes",
            field=models.ManyToManyField(related_name="productions", to="api.recipe"),
        ),
        migrations.CreateModel(
            name="IceCreamBase",
            fields=[
        ...
        migrations.AddField(
            ...
            name="ingredients",
            field=models.ManyToManyField(
                through="api.BaseIngredient", to="api.ingredient"
            ),
        ),
        migrations.AddField(
